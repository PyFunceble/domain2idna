...
def _get_version(full=False):
    ...
    extracted = to_match.findall(open("../domain2idna/__init__.py", encoding="utf-8").read())[0]
...
latex_documents = [
    (master_doc, 'domain2idna.tex', 'domain2idna Documentation',
...
man_pages = [
    (master_doc, 'domain2idna', 'domain2idna Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'domain2idna', 'domain2idna Documentation',
     author, 'domain2idna', 'One line description of project.',
     'Miscellaneous'),
]
